<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EndGame.aspx.cs" Inherits="RGUH.EndGame" %>
                ...
                <table style="text-align: left; width: 640px;" border="1">
                    <tr>
                        <td>
                            ...
                            <br />
                            <br />
                            &nbsp;Average Prize Points won:
                            <br />
                            <br />
                            <center>
                            <asp:Label ID="AveragePrizePointsLbl" runat="server" Font-Bold="true" ForeColor="Green" Font-Size="Larger"></asp:Label>
                            </center>
                            <br />
                            <br />
                            &nbsp;Your bonus is:
